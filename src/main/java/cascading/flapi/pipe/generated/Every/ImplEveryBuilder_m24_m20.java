...
public class ImplEveryBuilder_m24_m20
    implements EveryBuilder_m24_m20, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m24_m20(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m24 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m24 step1 = new ImplEveryBuilder_m24(_helper, _returnValue);
