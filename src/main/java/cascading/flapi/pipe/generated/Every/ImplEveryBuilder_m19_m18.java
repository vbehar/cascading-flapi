...
public class ImplEveryBuilder_m19_m18
    implements EveryBuilder_m19_m18, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m19_m18(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m19 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m19 step1 = new ImplEveryBuilder_m19(_helper, _returnValue);
