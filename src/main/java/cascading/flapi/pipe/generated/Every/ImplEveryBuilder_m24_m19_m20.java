...
public class ImplEveryBuilder_m24_m19_m20
    implements EveryBuilder_m24_m19_m20, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m24_m19_m20(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m24_m20 produce(Comparable... output) {
        _helper.produce(output);
        ImplEveryBuilder_m24_m20 step1 = new ImplEveryBuilder_m24_m20(_helper, _returnValue);
     ...
     * 
     */
    public EveryBuilder_m24_m19 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m24_m19 step1 = new ImplEveryBuilder_m24_m19(_helper, _returnValue);
