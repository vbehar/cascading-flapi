...
public class ImplEveryBuilder_m13_m11_m12
    implements EveryBuilder_m13_m11_m12, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m13_m11_m12(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m13_m12 produce(Comparable... output) {
        _helper.produce(output);
        ImplEveryBuilder_m13_m12 step1 = new ImplEveryBuilder_m13_m12(_helper, _returnValue);
     ...
     * 
     */
    public EveryBuilder_m13_m11 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m13_m11 step1 = new ImplEveryBuilder_m13_m11(_helper, _returnValue);
