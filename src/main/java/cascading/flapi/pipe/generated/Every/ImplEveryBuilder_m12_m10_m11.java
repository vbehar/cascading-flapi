...
public class ImplEveryBuilder_m12_m10_m11
    implements EveryBuilder_m12_m10_m11, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m12_m10_m11(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m12_m11 produce(Comparable... output) {
        _helper.produce(output);
        ImplEveryBuilder_m12_m11 step1 = new ImplEveryBuilder_m12_m11(_helper, _returnValue);
     ...
     * 
     */
    public EveryBuilder_m12_m10 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m12_m10 step1 = new ImplEveryBuilder_m12_m10(_helper, _returnValue);
