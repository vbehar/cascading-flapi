...
public class ImplEveryBuilder_m13_m12
    implements EveryBuilder_m13_m12, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m13_m12(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m13 select(Comparable... arguments) {
