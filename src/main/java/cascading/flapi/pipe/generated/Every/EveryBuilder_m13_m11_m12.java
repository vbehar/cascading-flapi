...
public interface EveryBuilder_m13_m11_m12 <_ReturnType >{
     ...
     * 
     */
    EveryBuilder_m13_m12 <_ReturnType> produce(Comparable... output);

    /**
     * Restrict the fields to be used as the 'argument selector' for this operation
     * 
     */
    EveryBuilder_m13_m11 <_ReturnType> select(Comparable... arguments);
