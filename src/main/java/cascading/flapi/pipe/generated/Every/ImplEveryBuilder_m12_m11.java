...
public class ImplEveryBuilder_m12_m11
    implements EveryBuilder_m12_m11, BuilderImplementation
{

    private final EveryHelper _helper;
    private final Object _returnValue;

    public ImplEveryBuilder_m12_m11(EveryHelper helper, Object returnValue) {
        _helper = helper;
     ...
     * 
     */
    public EveryBuilder_m12 select(Comparable... arguments) {
        _helper.select(arguments);
        ImplEveryBuilder_m12 step1 = new ImplEveryBuilder_m12(_helper, _returnValue);
